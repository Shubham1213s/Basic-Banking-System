<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #C0392B;"><b>THE SPARK FOUNDATION BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="transectionhistory.php" style="color : #C0392B;"><b>Transaction History</b></a>
              </li>
          </div>
       </nav>